  ...
  return (
    <motion.div
      ...
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000000a4]">subtotal:</h3>
        <h5 className="text-[18px] font-[600]">$2000</h5>
      </div>
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000000a4]">shipping:</h3>
        <h5 className="text-[18px] font-[600]">$10</h5>
      </div>
      <br />
      <div className="flex justify-between border-b pb-3">
        <h3 className="text-[16px] font-[400] text-[#000000000a4]">Discount:</h3>
