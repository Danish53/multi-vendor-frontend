...
const AddNewAddress = ({ setOpen, open }) => {
  ...
  return (
    <>
      <div className="w-full h-screen bg-[#00000000060] fixed top-0 left-0 z-50 flex items-center justify-center ">
        <motion.div
          ...
          <div className="w-full flex items-end justify-end p-2">
            <RxCross1
              size={40}
              className="cursor-pointer p-2 hover:bg-[#0000000001b] transition rounded-full"
