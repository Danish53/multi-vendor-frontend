          ...
          <div className="flex w-full flex-wrap pb-3">
            ...
            <div className="w-full 800px:w-[50%] pb-4">
              ...
              <input
                ...
                className={`${styles.input} !w-[95%] focus:border-[#000000]`}
              />
            </div>
            ...
            {/* button */}
            <div
              className={`${styles.button} hover:text-white !rounded-[5px] w-[30%] transition !h-11 border bg-transparent border-[#000000] hover:bg-[#000000]`}>
