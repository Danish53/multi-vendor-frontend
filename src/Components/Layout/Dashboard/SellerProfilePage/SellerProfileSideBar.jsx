  ...
  return (
    <>
      <div className="w-full py-5">
        <div className="flex items-center justify-center w-full">
          <img
            ...
            alt="seller/image"
            title="Profile"
            className="800px:w-[150px] 800px:h-[150px] w-[120px] h-[120px] object-cover cursor-pointer border border-[#000000] rounded-full"
          />
        </div>
        <h3 className="py-2 text-center font-[600] text-[20px]">
          {sellerInfo?.name}
        </h3>
        <p className="text-[#000000000a6] text-justify text-[16px] flex items-center px-[10px]">
      ...
      <div className="p-3 h-max w-max">
        ...
        <p className="text-[#000000000a6]">{sellerInfo.address}</p>
      </div>

      <div className="p-2">
        <h3 className="font-[600]">Phone Number</h3>
        <p className="text-[#000000000a6]">{sellerInfo.phoneNumber}</p>
      </div>

      <div className="p-2">
        <h3 className="font-[600]">Total Products</h3>
        <p className="text-[#000000000a6]">{productData.length || 0}</p>
      </div>

      <div className="p-2">
        <h3 className="font-[600]">Shop Ratings</h3>
        <p className="text-[#000000000a6]">4.2</p>
      </div>

      <div className="p-2">
        <h3 className="font-[600]">Joined On</h3>
        <p className="text-[#000000000a6]">{sellerJoinDate}</p>
      </div>
