        ...
        <div className="800px:flex items-center justify-between block">
          <motion.div
            ...
            <div className="flex items-center">
              ...
              <h5
                className={`${Styles.productTitle} !text-[18px] !font-[600] !text-[#00000000085] leading-5`}>
                Account balance{" "}
                <span className="text-[16px] font-[500] text-[#00000000085]">
          ...
          <motion.div
            ...
            <div className="flex items-center">
              <MdBorderClear size={25} className="mr-2" color="#00000000085" />
