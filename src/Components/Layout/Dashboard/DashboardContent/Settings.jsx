      ...
      <div className="flex justify-center w-full">
        <div className="relative h-[150px]">
          <img
            ...
            alt="profile/image"
            className="w-[150px] h-[150px] object-cover rounded-full border-[3px] border-[#000000]"
          />
          ...
          <div className="flex w-full flex-wrap pb-3">
            ...
            <div className="w-full 800px:w-[50%] pb-4">
              ...
              <input
                ...
                className={`${styles.input} py-2 !w-[95%] focus:border-[#000000]`}
              />
            </div>
            ...
            {/* button */}
            <div
              className={`${styles.button} hover:text-white mx-auto !rounded-[5px] w-[80%] 800px:w-[50%] transition !h-11 border bg-transparent border-[#000000] hover:bg-[#000000]`}>
